      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm  
            <span className='text-[#915eff]'> Jayesh Gurav 
            </span></h1>

          <p className={` ${styles.heroSubText} mt-1 text-white-100`}>
            {/* i develop 3d visuals, user <br className='sm: block hidden'/>interfaces and web applications  */}
            I chose to study <span className='text-[#915eff]'> AIML (CSE)
            </span> because I have a passion for programming and the ability to make a computer do anything I desire with the right knowledge.
